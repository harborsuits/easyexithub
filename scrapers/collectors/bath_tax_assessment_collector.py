...
It uses the Vision Government Solutions (VGSI) website for Bath.
"""
...
class BathTaxAssessmentCollector(VGSICollector):
    """
    Collects property data from the Bath tax assessment database using VGSI
    """
    ...
    def __init__(self, 
        ...
        """
        # Initialize the VGSI collector with Bath specifics
        super().__init__(town="bath", state="me")
    ...
    def collect(self) -> List[Dict[str, Any]]:
        ...
        for prop in properties:
            prop['data_source'] = "bath_tax_assessment"
            prop['location'] = "Bath"
    ...
    def transform_to_leads(self, properties: List[Dict[str, Any]]) -> List[Dict[str, Any]]:
        ...
        for prop in properties:
            ...
            lead = {
                "lead_id": f"bath-tax-{prop.get('parcel_id', '')}",
